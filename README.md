...
**组件中的每次 render 都有其特定且独立的 props 和 state**
...
**在使用定时器时，定时器中的内部函数总会捕捉到特定 render 的 props 和 state**
...
**在函数组件中调用的所有事件处理器、定时器或者其他的 API 都只会捕获到特定 render 中的 props 和 state 。**

**useEffect 中的 cleanup 函数：** 
